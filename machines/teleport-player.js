module.exports = {
    ...
    inputs: {
        ...
        playerID: {
            type: 'string',
            description: 'Steam ID of the player to teleport',
    ...
    fn: function(inputs, exits) {
     ...
     console.log()
        ...
        let reason = ''
        if (!_.isUndefined(inputs.reason)) {
	    ...
	    console.log(response)
                if (response.result == '*** ERROR: Executing command \'tele\' failed could not find player') {
                    return exits.unknownPlayer("Could not find player")
		console.log(response)
                }
